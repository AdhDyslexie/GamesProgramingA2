...
public class AllItemDefinitions {
    ...
    AllItemDefinitions() {
        ...
        items[0] = new ItemDefinition(GameEngine.subImage(tileSet, 0, 0, 32, 32), "Rock", "Ohhhh yeahhhhh what a rock", 0, 10, ItemDefinition.PlantType.LEAFY, ItemDefinition.MainColor.BROWN);
