...
public class Main extends GameEngine{
    ...
    public void init() {
        ...
        npc = new Npc(450, 450, 30, 50, tempimage, items.getDefinitionAtIndex(0));

        floorItems = new ItemInstance[2];
        floorItems[0] = new ItemInstance(220, 230, false, items.getDefinitionAtIndex(10));
        floorItems[1] = new ItemInstance(250, 270, false, items.getDefinitionAtIndex(11));
